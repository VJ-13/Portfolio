...
export default function Skills({}: Props) {
  return (
    <motion.div 
        ...
        <h3 className='absolute top-36 uppercase tracking-[3px] text-gray-500 text-sm my-auto xl:top-36 lg:top-36 md:top-36 sm:top-15 '>Hover over a skill for current proficiency</h3>
