...
export default function Skills({}: Props) {
  return (
    <motion.div 
        ...
        <h3 className='absolute top-24 uppercase tracking-[20px] text-gray-500 text-2xl my-auto xl:top-24 lg:top-24 md:top-24 sm:top-15 '>Skills</h3>

        <h3 className='absolute top-36 uppercase tracking-[3px] text-[#00B8EA]/80 text-sm my-auto xl:top-36 lg:top-36 md:top-36 sm:top-15 '>Hover over a skill for current proficiency</h3>
