            ...
            {/* Project Cards */}
            {
                projects.map(({id, src, name, description, codeLink, demoLink}) => (
                    ...
                    <div className='flex items-center justify-center '>
                        <Button href={demoLink} variant="outlined" className=' inherit w-60 px-16 m-8 heroButton z-20'>Demo</Button>
                        <Button href={codeLink} variant="outlined" className=' inherit w-60 px-16 m-8 heroButton z-20'>Code</Button>
                    </div>
