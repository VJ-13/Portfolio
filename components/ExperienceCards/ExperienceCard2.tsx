  ...
  return (
    <article className='flex flex-col rounded-lg items-center spaces-y-7 flex-shrink-0 w-[500px] md:w-[600px] xl:w-[900px] snap-center bg-[#292929] p-10 
        ...
        <div className='px-0 md:px-10 '>
            ...
            <p className='uppercase py-5 text-gray-300'>May 2022 - Aug 2022</p>

            <ul className='list-disc space-y-4 ml-5 text-lg'>
                <li>Collaborated with a team of developers using Java in Android Studio, to integrate Bluetooth Low Energy (BLE) technology, resulting in a 20% reduction in customer search times by enhancing location-based features.</li>
                <li>Ensured successful delivery of software solutions by adhering to Agile principles within a Scrum team.</li>
            </ul>
        </div>
    </article>
  )
